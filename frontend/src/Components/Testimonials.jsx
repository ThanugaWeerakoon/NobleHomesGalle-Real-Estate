...
import "swiper/css/pagination"; // Import necessary styles
import { Pagination } from "swiper/modules"; // Import modules from swiper/modules
import { Autoplay } from "swiper/modules"; // Autoplay module from swiper/modules
      ...
      <div className="flex justify-center items-center">
        <div className="w-full md:w-3/4 lg:w-3/4">
          <Swiper
            ...
            loop={true}
            modules={[Autoplay, Pagination]} // Use modules
            className="mySwiper"
            style={{ height: "auto" }}
            breakpoints={{
              1024: {
